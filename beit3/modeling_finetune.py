...
class BEiT3ForHatefulMemes(BEiT3Wrapper):
    def __init__(
            self, 
            args, 
            num_classes, 
        ...
        super(BEiT3ForHatefulMemes, self).__init__(args=args)
...
#-----------------------------------------------------------
# Begin original code contribution based on existing methods
#-----------------------------------------------------------

@register_model
def beit3_base_patch16_224_hateful_memes(pretrained=False, **kwargs):
    args = _get_base_config(**kwargs)
    model = BEiT3ForHatefulMemes(args, num_classes=2, **kwargs)
    return model


@register_model
def beit3_large_patch16_224_hateful_memes(pretrained=False, **kwargs):
    args = _get_large_config(**kwargs)
    model = BEiT3ForHatefulMemes(args, num_classes=2, **kwargs)
    return model
